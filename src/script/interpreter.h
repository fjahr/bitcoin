...
struct CISAWitness {
    //! Aggregation mode marker (CISA_MARKER_HALFAGG/FULLAGG), std::nullopt
    //! for opted-out inputs.
    ...
    //! Aggregate signature on the final input of a group, entire BIP341
    //! signature of an opted-out input, or empty for placeholders. Points
    //! into the element passed to ParseCISAWitness().
