...
class P2PFeatureTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.test_dummy_announced_to_modern_peer()  # TODO: Remove before merge
    ...
    def test_dummy_announced_to_modern_peer(self):
        # TODO: Delete me
        self.log.info("Test that node announces the placeholder DUMMY feature to a 70017 peer")
        peer = self.nodes[0].add_p2p_connection(FeaturePeer())
