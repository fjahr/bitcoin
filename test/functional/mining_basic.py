...
class MiningTest(BitcoinTestFramework):
    ...
    def test_murch_zawy_mintime(self):
        ...
        bad_block = create_block(tmpl=tmpl, ntime=first_block_time - 1)
        bad_block.solve()
        assert_raises_rpc_error(-25, 'time-negative-interval', lambda: node.submitheader(hexdata=CBlockHeader(bad_block).serialize().hex()))
