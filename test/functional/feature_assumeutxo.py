...
class AssumeutxoTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert 'NETWORK' not in prune_node_services
        assert 'NETWORK_LIMITED' in prune_node_services
        ...
        full_node_services = n2.getnetworkinfo()['localservicesnames']
        assert 'NETWORK' not in full_node_services
        assert 'NETWORK_LIMITED' in full_node_services
